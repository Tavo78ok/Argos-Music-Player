...
class ArgOSMusicPlayer(Adw.ApplicationWindow):
    def __init__(self,app):
        ...
        self._ss=None  # se asigna en _build_library(), antes de cualquier señal de queue
    ...
    def _load_cover(self, s):
        if s.cover:
            try:
                ...
                # Extraer color en hilo para no bloquear la UI
    ...
    def _apply_cover_color_rgb(self, r, g, b):
        ...
        self._dynamic_css.load_from_data(css.encode())
